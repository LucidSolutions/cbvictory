...
component{
	// Layout Variables
    this.name       	= "Victory";
	this.description 	= "Victory is a HTML CSS template";
	this.version		= "1.0.0";
	...
	this.settings = [
		...
		{ name="blogLayout", group="Blog Sidebar Options", defaultValue="Two Column", type="select", label="Blog Layout", optionsUDF="getLayout" },
		{ name="footerBox", group="Footer", defaultValue="", type="textarea", 	label="Footer About:", groupIntro="Customize the footer of your site."  },
		
		{ name="facebookUrl", 	group="Social Share Options", defaultValue="", type="text",	label="Facebook share url", 	required="false" },
		{ name="twitterUrl", 	group="Social Share Options", defaultValue="", type="text",	label="Twitter share url", 	required="false" },
		{ name="instagramUrl", 	group="Social Share Options", defaultValue="", type="text",	label="Instagram share url", 	required="false" },
		{ name="rssUrl", 	group="Social Share Options", defaultValue="", type="text",	label="RSS share url", 	required="false" },
		{ name="dribbbleUrl", 	group="Social Share Options", defaultValue="", type="text",	label="Dribbble share url", 	required="false" },
	...
	/**
	* Build the blog layout options
	*/
	array function getLayout(){
		return [ 
			"One Column",
			"Two Column"
		];
